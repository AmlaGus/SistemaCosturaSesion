    ...
    var P = function (h) {
        ...
        function Ta(a, b, c) {
            ...
            0 === f || -1 === d ? e = 0 : "number" === typeof b ? (e = b * d, e > f && (e = 0)) :
                "first" == b ? e = 0 : "previous" == b ? (e = 0 <= d ? e - d : 0, 0 > e && (e = 0)) : "Siguiente" == b ? e + d < f && (e += d) : "last" == b ? e = Math.floor((f - 1) / d) * d : I(a, 0, "Unknown paging action: " + b, 5);
        ...
        h.extend(Mb, {
            simple: function () {
                ...
                return ["first", "previous", Wa(a, b), "Siguiente", "last"]
